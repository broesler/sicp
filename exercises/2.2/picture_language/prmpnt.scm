...
; (define floating-vector-ref (access floating-vector-ref (->environment (the-environment))))
; (define floating-vector-set! (access floating-vector-set! (->environment (the-environment))))
